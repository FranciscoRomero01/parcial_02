...
#Fondo
fondo = pygame.image.load(r"img\fondos\fondo_toyStory.jpg").convert()#Acelera el juego y hace que consuma menos recursos
fondo = pygame.transform.scale(fondo, (W,H))


plataforma_1_img = pygame.image.load(r"img\plataformas\plataforma_nivel2.png")
...
piso = Plataforma(0, 660, 1200, 50, "", False, False)
plataforma_1 = Plataforma(250, 400, 200, 100, plataforma_1_img, False, True)



plataformas = [piso, plataforma_1]
